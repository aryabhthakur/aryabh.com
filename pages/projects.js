    ...
    <DefaultLayout>
        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-row gap-4">
                ...
                {
                Object.entries(props.brahmagniRepodata).map((value,index)=>{
                    if (value[1].archived != true)
                    return(<>
                    <div key={index}>
                        <div className="border mb-2 shadow-lg shadow-slate-100 hover:border-gray-300 rounded-lg p-2 hover:scale-105 hover:shadow-2xl cursor-pointer duration-100">
...
export async function getStaticProps() {
    ...
    const brahmagniRepores = await fetch(`https://api.github.com/orgs/brahmagni/repos`)
    const brahmagniRepodata = await brahmagniRepores.json()
    ...
    return {
      props: {personalRepodata,coinPascalRepodata,brahmagniRepodata}, // will be passed to the page component as props
    }
  }